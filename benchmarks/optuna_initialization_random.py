...
parameters = {
    ...
    "initialize_with": "random FI 2dim",
    "initialization_method": "random FI 2dim",
    "feature_names": None,
    "class_names": None,
...
def modt_wrapper(X, y , init_learning_rate, learning_rate_decay):
    ...
    parameters["X"] = X
    parameters["y"] = y
    parameters["initialize_with"] = "random"
...
for idx_trial in range(n_trials):
    ...
    (train_score, 
     ...
     train_score_i_0,
     train_score_i_9,
     completed_iterations) = cross_validation(init_learning_rate=None,
