...
parameters = {
    ...
    "initialization_method": "_KDTmeans FI 2dim",
    "feature_names": None,
    "class_names": None,
...
def modt_wrapper(X, y , alpha, beta, gamma):
...
distributions = {
    "alpha": optuna.distributions.UniformDistribution(0.8,4),
    "beta": optuna.distributions.UniformDistribution(0.01,0.3),
    "gamma": optuna.distributions.UniformDistribution(0.01,0.3),
}
...
for idx_trial in range(n_trials):
    ...
    (train_score, 
     ...
     train_score_i_0,
     train_score_i_9,
     completed_iterations) = cross_validation(alpha=alpha, beta=beta, gamma=gamma)
